...
# The n adjacent digits in the 1000-digit number that have the greatest product.
...
def largestProductinaSeries(thousandDigits, n):
	lists = list_generator_function(thousandDigits, n)
	return max(reduce((lambda x,y: x*y), lst) for lst in lists)
